...
public class AppTranslationRecord extends UpdatableRecordImpl<AppTranslationRecord> implements Record7<String, String, String, String, String, String, Timestamp> {

	private static final long serialVersionUID = -292398786;
	 ...
	 */
	@Override
	public AppTranslationRecord values(String value1, String value2, String value3, String value4, String value5, String value6, Timestamp value7) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public AppTranslationRecord(String id, String locale, String processName, String viewName, String tag, String translation, Timestamp created) {
		super(AppTranslation.APP_TRANSLATION);

		setValue(0, id);
		setValue(1, locale);
		setValue(2, processName);
		setValue(3, viewName);
		setValue(4, tag);
		setValue(5, translation);
		setValue(6, created);
	}
}
