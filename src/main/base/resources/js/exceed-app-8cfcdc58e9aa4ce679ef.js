...
(0, _domready2.default)(function () {
    ...
    _es6PromisePolyfill.Promise.all([_svgLayout2.default.init()]).then(function () {
        ...
        return new _es6PromisePolyfill.Promise(function (resolve, reject) {
            ...
            var isHydration = !!rootElem.innerHTML;
            var renderFn = isHydration ? _reactDom2.default.hydrate : _reactDom2.default.render;

            renderFn(viewService.render(store, isHydration), rootElem, resolve);
        });
    }).then(function () {
...
//# sourceMappingURL=exceed-app-8cfcdc58e9aa4ce679ef.js.map