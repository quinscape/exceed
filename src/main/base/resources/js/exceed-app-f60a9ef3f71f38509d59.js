...
(0, _domready2.default)(function () {
    ...
    _es6PromisePolyfill.Promise.all([_svgLayout2.default.init()]).then(function () {
        ...
        return new _es6PromisePolyfill.Promise(function (resolve, reject) {
            ...
            var renderFn = !!rootElem.innerHTML ? _reactDom2.default.hydrate : _reactDom2.default.render;

            renderFn(viewService.render(store), rootElem, resolve);
        });
    }).then(function () {
...
//# sourceMappingURL=exceed-app-f60a9ef3f71f38509d59.js.map